...
In addition to my front-end skills, I have experience working with Node.js and MongoDB on the backend and have used libraries such as Context, Redux, Mui, and Ant-Design to manage state and design in my projects. I am comfortable using Git for version control and am familiar with tools like GitHub and VSCode for collaboration and development.

I am constantly learning and improving my skills in web development, and I am always looking for new challenges and opportunities to grow as a developer. My goal is to create intuitive and user-friendly websites and applications that are visually appealing and functional.

I am excited to connect with other professionals in the industry and am open to new opportunities and collaborations. Thank you for visiting my profile, I look forward to connecting with you!
